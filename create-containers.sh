...
docker build -t $REPOSITORY/frontend:$VERSION_STREAM -f ./pvapp/frontend/Dockerfile ./pvapp/frontend
docker push $REPOSITORY/frontend:$VERSION_STREAM

docker build -t $REPOSITORY/localapi:$VERSION_STREAM -f ./pvapp/localapi/Dockerfile ./pvapp/localapi/
